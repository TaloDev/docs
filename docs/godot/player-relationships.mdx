...
You also need to know the target player alias' ID. You can get this through methods such as [player presence updates](/docs/godot/player-presence), or by searching for players using [player search](/docs/godot/player-props#searching-for-players).
...
await Talo.player_relationships.subscribe_to(target_alias_id, Talo.player_relationships.RelationshipType.UNIDIRECTIONAL)

# or, bidirectional relationship
await Talo.player_relationships.subscribe_to(target_alias_id, Talo.player_relationships.RelationshipType.BIDIRECTIONAL)
```
...
for subscription in page.subscriptions:
    print("Subscribed to: %s" % subscription.player_alias.identifier)
```
...
for subscription in page.subscriptions:
    print("Subscriber: %s" % subscription.player_alias.identifier)
```
