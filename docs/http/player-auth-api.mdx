...
<ServiceDocumentation
  ...
  metaDescription="Talo's Player Authentication service lets you authenticate players using email, username, or any other identifier you choose. Players can also reset their password, verify their email, and more."
/>
