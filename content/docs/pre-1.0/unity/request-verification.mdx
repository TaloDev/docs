---
description: Enable request verification in the Unity package to cryptographically sign network requests and socket messages, preventing replay attacks and tampering.
