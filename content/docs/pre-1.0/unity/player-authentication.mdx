...
Here is an example of migrating to a [Steam alias](/docs/pre-1.0/unity/identifying#steamworks-integration):
...
You can also migrate to the `google_play_games` service by providing an [auth code](/docs/pre-1.0/unity/identifying#google-play-games-integration).
