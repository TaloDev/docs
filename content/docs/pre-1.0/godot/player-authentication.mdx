...
Here is an example of migrating to a [Steam alias](/pre-1.0/godot/identifying#steamworks-integration):
...
You can also migrate to the `google_play_games` service by providing an [auth code](/pre-1.0/godot/identifying#google-play-games-integration).
