...
Unlike the gameplay-orientated [HTTP API](/docs/pre-1.0/http/authentication), which authenticates requests on behalf of players, the Admin API authenticates requests using admin API keys scoped to your game.
