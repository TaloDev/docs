---
description: Talo groups let you apply filters to your player-base to create distinct segments. Use them for analytics, in-game checks and targeted messaging.
