...
Here is an example of migrating to a [Steam alias](/1.x/unity/identifying#steamworks-integration):
...
You can also migrate to the `google_play_games` service by providing an [auth code](/1.x/unity/identifying#google-play-games-integration).
