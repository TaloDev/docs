...
You also need to know the target player alias' ID. You can get this through [player presence updates](/1.x/unity/player-presence), or by searching for players using [player search](/1.x/unity/player-props#searching-for-players).
