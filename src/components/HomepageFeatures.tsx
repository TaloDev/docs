...
const FeatureList = [
  {
    ...
    engineIcon: true,
    description: <>Build your Godot game faster with our Talo plugin.</>,
  ...
  },
  {
    ...
    engineIcon: true,
    description: <>Take full advantage of Talo through our convenient Unity package.</>,
    link: '/docs/unity/install',
  },
  {
    title: 'API reference',
    Svg: require('../../static/img/tabler-icon-world.svg').default,
    description: <>Documentation for Talo's available API endpoints and how to use them.</>,
    link: '/docs/http/authentication',
  },
  {
    title: 'Socket reference',
    Svg: require('../../static/img/tabler-icon-topology-bus.svg').default,
    description: <>A reference guide for the available Talo socket message types and payloads.</>,
    link: '/docs/sockets/intro',
  },
  {
    title: 'Self-hosting',
    Svg: require('../../static/img/tabler-icon-server.svg').default,
    description: <>Configure Talo on your own servers using Docker and our quickstart examples.</>,
      ...
      <Link to={link}>
        <div className={styles.feature}>
          <div className={styles.titleIconWrapper}>
            <Svg className={clsx(styles.featureSvg, { [styles.engineIcon]: engineIcon })} />
            <h3>{title}</h3>
          </div>
